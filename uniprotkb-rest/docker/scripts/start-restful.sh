...
STREAMER_UNIPROT_SEARCH_BATCH_SIZE=1000
STREAMER_UNIPROT_STORE_BATCH_SIZE=5000
STREAMER_UNIPROT_STORE_FETCH_MAX_RETRIES=5
STREAMER_UNIPROT_STORE_FETCH_RETRY_DELAY_MILLIS=500
...
SOLR_VIEWBY_EC_DIR=$RESTFUL_LIB_DIR/ff/ec/
SOLR_VIEWBY_KEYWORD_FILE=$RESTFUL_LIB_DIR/ff/keywlist.txt
SOLR_VIEWBY_UNIPATHWAY_FILE=$RESTFUL_LIB_DIR/ff/unipathway.txt
...
function creaate_application_properties() {
    ...
    echo "streamer.uniprot.searchBatchSize=$STREAMER_UNIPROT_SEARCH_BATCH_SIZE" >> $APPLICATION_PROPERTIES_FILE
    echo "streamer.uniprot.storeBatchSize=$STREAMER_UNIPROT_STORE_BATCH_SIZE" >> $APPLICATION_PROPERTIES_FILE
    echo "streamer.uniprot.storeFetchMaxRetries=$STREAMER_UNIPROT_STORE_FETCH_MAX_RETRIES" >> $APPLICATION_PROPERTIES_FILE
    echo "streamer.uniprot.storeFetchRetryDelayMillis=$STREAMER_UNIPROT_STORE_FETCH_RETRY_DELAY_MILLIS" >> $APPLICATION_PROPERTIES_FILE
...
-jar $RESTFUL_LIB_DIR/lib/uniprotkb-rest-exec.jar"
